...
- **2026-08-02, @manzt (approval and merge):** approved the escape-HTML fix and merged the PR (merge commit `d85f2b9cd`, 12:41Z, closed #581), 28 minutes after the push. **PR #643 is merged.**
...
- **2026-08-02, @manzt (approval and merge):** "Thanks for the contribution!" Approved and merged the PR (closed #531). **PR #644 is merged.**

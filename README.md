...
| — | — | *awaiting @s3alfisc's decision on the predict-level warning; PR #1368 mergeable and fully green* | — |
...
**Outcome so far:** bonus PR #1369 **merged same-day** (approved by @leostimpfle; @s3alfisc added me to the project's all-contributors list). Main fix #1368 all-green and mergeable; on 2026-07-03 @leostimpfle reviewed and refactored it — moving the unseen-level warning into the shared `predict` path and stripping my `did2s` boilerplate — and deferred the final call to @s3alfisc. I endorsed the cleaner design; awaiting the lead maintainer's decision.

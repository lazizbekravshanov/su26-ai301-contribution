...
| 5 | [#412 — Add flags and options to support user-defined templates](https://github.com/orhun/git-cliff/issues/412) | [orhun/git-cliff](https://github.com/orhun/git-cliff) (Rust) | [PR #1583](https://github.com/orhun/git-cliff/pull/1583) — `--templates-dir <PATH>` + `GIT_CLIFF_TEMPLATES_DIR`, `--list-templates`, user templates override built-ins | 🔄 **In review** — TDD (10 tests), workspace `cargo test`/`clippy`/`fmt` green; PR #1583 opened 2026-07-13, CI running |

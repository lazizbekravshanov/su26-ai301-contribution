...
**Status as of 2026-08-04:** Ten contribution cycles across three languages (TypeScript, Python, Rust) and six projects: **9 PRs merged · 5 in review.** One of the in-review PRs (mteb #5026) is already approved by both maintainers and awaiting merge. Full per-contribution status is in the [table below](#contributions-at-a-glance). The live (unmerged) work, ordered by how close it is to landing:
...
- 🔄 **[git-cliff #1583](https://github.com/orhun/git-cliff/pull/1583) / [#1584](https://github.com/orhun/git-cliff/pull/1584)** (Cycle 5), user-defined templates (`--templates-dir`) and `.config` discovery cleanup for [orhun/git-cliff](https://github.com/orhun/git-cliff) (Rust). Complete, rebased fresh onto current upstream (2026-07-30) with tests, clippy, and nightly fmt clean. Awaiting @orhun's review.
- ⚠️ **[pyfixest #1236](https://github.com/py-econometrics/pyfixest/issues/1236)** (Cycle 10), predict NA handling. Investigation found the behavior is intended and matches R fixest. **[PR #1429](https://github.com/py-econometrics/pyfixest/pull/1429)** (`Part of #1236`, branch `issue-1236-predict-na-handling`, `53feeab4`) is open on GitHub, ahead of the wait-mode plan recorded below (open only after @s3alfisc replies and I confirm) — as of 2026-08-04 @s3alfisc has not replied to the investigation comment on #1236, and I have not confirmed opening it. Flagged for review of how to proceed; no further action taken on it this cycle.
...
| 10 | [#1236: NA handling for predict and predict with new data](https://github.com/py-econometrics/pyfixest/issues/1236) | [py-econometrics/pyfixest](https://github.com/py-econometrics/pyfixest) (Python) | [PR #1429](https://github.com/py-econometrics/pyfixest/pull/1429), warn on silent covariate-NaN predictions + document both `predict` branches (branch `issue-1236-predict-na-handling`, `53feeab4`) | ⚠️ **PR opened** 2026-07-28 (`Part of #1236`), ahead of the wait-mode plan below (open only after @s3alfisc replies to the investigation comment and I confirm) — no @s3alfisc reply yet as of 2026-08-04. Flagged for review |

...
**Status as of 2026-08-04:** Ten contribution cycles across three languages (TypeScript, Python, Rust) and six projects: **9 PRs merged · 2 in review · 3 withdrawn.** One of the in-review PRs (mteb #5026) is already approved by both maintainers and awaiting merge. Full per-contribution status is in the [table below](#contributions-at-a-glance). The live (unmerged) work, ordered by how close it is to landing:

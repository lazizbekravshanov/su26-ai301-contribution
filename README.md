...
- 🔄 **[marimo-lsp #644](https://github.com/marimo-team/marimo-lsp/pull/644)** (Cycle 9), save the dirty buffer before opening a file as a notebook so unsaved content is never destroyed ([#531](https://github.com/marimo-team/marimo-lsp/issues/531)). A data-loss fix, CLA signed, rebased, CI green, manual GUI confirmed. Awaiting @manzt's review.

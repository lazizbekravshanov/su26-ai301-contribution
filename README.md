...
**pudl #5431, reply posted (2026-08-02 check).** Posted the drafted reply to @zaneselvans confirming which parts of `pytest-ci` were run locally (unit tests, Dagster materialize, `dbt_helper validate`; not the full integration suite, which needs an ETL data environment this workspace doesn't have). No maintainer response yet as of this check.
...
- **2026-08-02, @manzt (approval and merge):** approved the escape-HTML fix and merged the PR (closed #581). **PR #643 is merged.**

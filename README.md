...
- 🔄 **[pudl #5431](https://github.com/catalyst-cooperative/pudl/pull/5431)** (Cycle 6), EIA-923 fuel-stocks integration for [catalyst-cooperative/pudl](https://github.com/catalyst-cooperative/pudl) ([#5081](https://github.com/catalyst-cooperative/pudl/issues/5081)) (Python). Full build (Dagster `@asset`, resource and field metadata, alembic migration `c0d82da350c8`, dbt validations; 17,758 tall monthly rows), ready for review with `Closes #5081`. The @zaneselvans and @aesharpe review round is addressed (`2d0e02c7a`); the units decision is with the maintainers.
...
| 6 | [#5081: Integrate EIA 923 Stocks Data](https://github.com/catalyst-cooperative/pudl/issues/5081) | [catalyst-cooperative/pudl](https://github.com/catalyst-cooperative/pudl) (Python) | [PR #5431](https://github.com/catalyst-cooperative/pudl/pull/5431), inject `report_year` in the stocks extract, `_core_eia923__yearly_fuel_stocks` Dagster asset (wide monthly coal/oil/petcoke to tall monthly records), resource and field metadata, alembic migration, dbt validations, unit test | 🔄 **In review**, opened as a draft 2026-07-24 at the design checkpoint; @zaneselvans gave the go-ahead 2026-07-30, so I built the full implementation (asset, metadata, migration `c0d82da350c8`, dbt; materialized 17,758 rows), left `census_division_and_state` unconstrained, and marked it ready with `Closes #5081` |
...
in base units), alembic migration `c0d82da350c8` (alembic check reports no drift), and dbt validations

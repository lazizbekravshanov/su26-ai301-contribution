...
**Status as of 2026-08-02:** Ten contribution cycles across three languages (TypeScript, Python, Rust) and six projects: **9 PRs merged · 4 in review · 1 under investigation.** One of the in-review PRs (mteb #5026) is already approved by both maintainers and awaiting merge. Full per-contribution status is in the [table below](#contributions-at-a-glance). The live (unmerged) work, ordered by how close it is to landing:
...
- 🔍 **[pyfixest #1236](https://github.com/py-econometrics/pyfixest/issues/1236)** (Cycle 10), predict NA handling. Investigation found the behavior is intended and matches R fixest; posted the evidence plus a small warning fix on a branch and held the PR pending @s3alfisc's confirmation.

...
- 🔄 **[marimo-lsp #644](https://github.com/marimo-team/marimo-lsp/pull/644)** (Cycle 9), save the dirty buffer before opening a file as a notebook so unsaved content is never destroyed ([#531](https://github.com/marimo-team/marimo-lsp/issues/531)). A data-loss fix, CLA signed, rebased, CI green, manual GUI confirmed. @manzt reviewed 2026-07-30 and asked for a simpler document lookup and explicit handling of a failed save; addressed both and pushed (`9818afc`), awaiting re-review.
